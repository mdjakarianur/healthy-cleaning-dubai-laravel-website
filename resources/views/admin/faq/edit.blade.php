...
<div class="content">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form method="post" action="{{route('faq.update',$data['data']->id)}}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-2">
                        ...
                        <div class="showlabels">
                            <select class="form-select form-select-sm select2 @error('service_id') is-invalid @enderror" name="service_id" id="service_id">
                                ...
                                <option @if($data['data']->service_id == $service->id) selected @endif value="{{ $service->id }}">
                                    @if(config('app.locale') == 'en')
                                    {{ $service->service_name ?: $service->service_name_bn }}
                                    @else
                                    {{ $service->service_name_bn ?: $service->service_name }}
                                    @endif
                                </option>
                                @endforeach
                                @endif
                    ...
                    <div class="col-lg-6 col-md-6 col-12 mt-2">
                        ...
                        <input type="text" class="form-control form-control-sm @error('questions') is-invalid @enderror" name="questions" id="questions"  value="{{ $data['data']->questions }}">
                        @error('questions')
                            <div class="alert alert-danger">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-12 mt-4">
                        ...
                        <textarea type="text" class="form-control form-control-sm @error('answer') is-invalid @enderror" name="answer" id="summernote">{!! $data['data']->answer !!}</textarea>
                        @error('answer')
                        <div class="alert alert-danger">
                            {{ $message }}
                        </div>
