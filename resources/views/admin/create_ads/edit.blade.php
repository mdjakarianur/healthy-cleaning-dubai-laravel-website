...
<div class="content">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form method="post" action="{{route('create_ads.update',$data['data']->id)}}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-2">
                        ...
                        <input type="date" class="form-control form-control-sm @error('end_date') is-invalid @enderror" name="end_date" id="end_date"  value="{{ $data['data']->end_date }}">
                        @error('end_date')
                            <div class="alert alert-danger">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-2">
                        <label>@lang('create_ads.custom_url')</label><span class="text-danger">*</span>
                        <input type="text" class="form-control form-control-sm @error('custom_url') is-invalid @enderror" name="custom_url" id="custom_url"  value="{{ $data['data']->custom_url }}">
                        @error('custom_url')
                            <div class="alert alert-danger">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-2">
                        ...
                        <br>
                        @php
                            $pathImage = public_path().'//backend/Ads/AdsImage//'.$data['data']->image;
                        @endphp
                        @if(file_exists($pathImage))
                            <img src="{{ asset('/backend/Ads/AdsImage/') }}/{{ $data['data']->image }}" alt="" class="img-fluid" style="height: 70px;">
                        @endif
                    </div>
