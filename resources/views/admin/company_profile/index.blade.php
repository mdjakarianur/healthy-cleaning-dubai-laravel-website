                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-12 col-12 mt-4">
                                <label>@lang('company_profile.office_time')</label>
                                <textarea type="text" class="form-control form-control-sm @error('office_time') is-invalid @enderror" name="office_time" rows="4" id="summernote">{!! $data['data']->office_time !!}</textarea>
                                @error('office_time')
                                <div class="alert alert-danger">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="col-lg-6 col-md-12 col-12 mt-4">
                                <label>@lang('company_profile.short_details')</label>
                                <textarea type="text" class="form-control form-control-sm @error('short_details') is-invalid @enderror" name="short_details" rows="6">{!! $data['data']->short_details !!}</textarea>
                                @error('short_details')
                                <div class="alert alert-danger">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="col-lg-6 col-md-12 col-12 mt-4">
                                ...
                                <textarea type="text" class="form-control form-control-sm @error('address') is-invalid @enderror" name="address" id="summernote1">{!! $data['data']->address !!}</textarea>
                                @error('address')
                                <div class="alert alert-danger">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="col-lg-6 col-md-12 col-12 mt-4">
                                ...
                                <textarea type="text" class="form-control form-control-sm @error('map') is-invalid @enderror" name="map" rows="6">{!! $data['data']->map !!}</textarea>
                                @error('map')
                                <div class="alert alert-danger">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="col-lg-6 col-md-12 col-12 mt-4">
                                ...
                                <textarea type="text" class="form-control form-control-sm @error('meta_description') is-invalid @enderror" name="meta_description"  rows="6">{!! $data['data']->meta_description !!}</textarea>
