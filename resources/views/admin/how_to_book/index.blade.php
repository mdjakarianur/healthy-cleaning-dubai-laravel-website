...
<div class="content">
    ...
    <!-- link 2 -->
    @slot('link_two')
    @lang('how_to_book.how_to_book')
    @endslot
    @slot('link_two_url')
    {{route('how_to_book.index')}}
    @endslot
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form method="post" action="{{route('how_to_book.update',$data['data']->id)}}" enctype="multipart/form-data">
                @csrf
                @method("PUT")
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-12 mt-4">
                        <label>@lang('how_to_book.description')</label>
