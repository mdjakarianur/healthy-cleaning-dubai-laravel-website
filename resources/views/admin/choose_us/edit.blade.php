...
<div class="content">
    ...
    @if(Auth::user()->can('Why Choose Us view'))
    <!-- button one -->
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form method="post" action="{{route('choose_us.update',$data['data']->id)}}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-12 mt-2">
                        <label>@lang('choose_us.icon')</label><span class="text-danger">*</span>
                    ...
                    <div class="col-lg-6 col-md-6 col-12 mt-2">
                        <label>@lang('choose_us.title')</label><span class="text-danger">*</span>
                    ...
                    <div class="col-lg-6 col-md-12 col-12 mt-4">
                        <label>@lang('choose_us.details')</label>
                        <textarea type="text" class="form-control form-control-sm @error('details') is-invalid @enderror" name="details" id="summernote">{!! $data['data']->details !!}</textarea>
                        @error('details')
                        <div class="alert alert-danger">
                            {{ $message }}
                        </div>
