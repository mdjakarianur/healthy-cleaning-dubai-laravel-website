...
<div class="content">
    ...
    <!-- Active Link -->
    @slot('active_link')
    @lang('create_clients.create_title')
    @endslot
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form method="post" action="{{route('create_clients.store')}}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-12 mt-2">
                        <label>@lang('create_clients.email')</label><span class="text-danger">*</span>
                    ...
                    <div class="col-lg-6 col-md-6 col-12 mt-2">
                        <label>@lang('create_clients.phone')</label><span class="text-danger">*</span>
                    ...
                    <div class="col-lg-6 col-md-12 col-12 mt-2">
                        <label>@lang('create_clients.address')</label>
                        <textarea type="text" class="form-control form-control-sm @error('address') is-invalid @enderror" name="address"  id="summernote"></textarea>
                        @error('address')
                        <div class="alert alert-danger">
                            {{ $message }}
                        </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-12 mt-2">
                        <label>@lang('create_clients.description')</label>
