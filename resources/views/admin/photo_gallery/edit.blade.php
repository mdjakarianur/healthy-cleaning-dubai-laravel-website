        ...
        <div class="card-body">
            ...
            <form method="post" action="{{route('photo_gallery.update',$data['data']->id)}}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-12 mt-2">
                        <label>@lang('photo_gallery.url')</label><span class="text-danger">*</span>
                    ...
                    <div class="col-lg-6 col-md-6 col-12 mt-2">
                        ...
                        <br>
                        @php
                            $imagePath = public_path('backend/PhotoGallery/PhotoGalleryImage/' . ($data['data']->image ?? ''));
                        @endphp
                        @if(!empty($data['data']->image) && file_exists($imagePath))
                            <img src="{{ asset('backend/PhotoGallery/PhotoGalleryImage/' . $data['data']->image) }}"
