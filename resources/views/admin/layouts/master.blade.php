              ...
              <div class="d-flex align-items-center">
                <div class="d-flex align-items-center">
                  ...
                  @if(file_exists($pathlogo))
                      <img src="{{ asset('backend/CompanyProfile/CompanyProfileLogo') }}/{{ $company->logo }}" alt="" class="img-fluid">
                  @endif
                </div>
              </div>
            </a>
                    ...
                    <div class="card-footer p-0 border-top">
                      ...
                      <div class="px-3">
                        <form method="POST" action="{{ route('logout') }}">
                          @csrf
                          <x-dropdown-link class="btn btn-phoenix-secondary d-flex flex-center w-100" :href="route('logout')"
        ...
        <footer class="footer position-absolute">
            <div class="row g-0 justify-content-between align-items-center h-100">
              <div class="col-12 col-sm-auto text-center">
                <p class="mb-0 mt-2 mt-sm-0 text-900">Thank you for creating with SBIT<span class="d-none d-sm-inline-block"></span><span class="mx-1">|</span><br class="d-sm-none" /><script>document.write(new Date().getFullYear());</script> &copy; <a href="sbit.com.bd">Skill Based IT</a></p>
              </div>
              <div class="col-12 col-sm-auto text-center">
