                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-2">
                        ...
                        <div class="showlabels">
                            <select class="form-select form-select-sm @error('category_id') is-invalid @enderror" name="category_id" id="category_id" onchange="return GetCategorie()">
                    ...
                    {{-- <div class="col-lg-6 col-md-6 col-12 mt-2">
                        ...
                        <input type="text" class="form-control form-control-sm @error('video_link') is-invalid @enderror" name="video_link" id="video_link"  value="{{ old('video_link') }}">
                        @error('video_link')
                            <div class="alert alert-danger">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-12 mt-2">
                        <label>Favicon</label>
                        <input type="file" class="form-control form-control-sm @error('favicon') is-invalid @enderror" name="favicon" id="favicon">
                        @error('favicon')
                            <div class="alert alert-danger">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-12 mt-2">
                        ...
                        <div class="showlabels">
                            <select class="form-select form-select-sm @error('click') is-invalid @enderror" name="click" id="click" onchange="return GetCategorie()">
                                <option value="">@lang('common.select_one')</option>
                                <option value="1" @if(old('click') == 1) selected @endif>Yes</option>
                                <option value="0" @if(old('click') == 0) selected @endif>No</option>
                            </select>
                        </div>
                        @error('click')
                            <div class="alert alert-danger">
                    ...
                    <div class="col-lg-6 col-md-6 col-12 mt-2">
                        ...
                        <div class="showlabels">
                            <select class="form-select form-select-sm @error('select') is-invalid @enderror" name="select" id="select" onchange="return GetCategorie()">
                                <option value="">@lang('common.select_one')</option>
                                <option value="1" @if(old('select') == 1) selected @endif>Yes</option>
                                <option value="0" @if(old('select') == 0) selected @endif>No</option>
                            </select>
                        </div>
                        @error('select')
                            <div class="alert alert-danger">
                    ...
                    <div class="col-lg-6 col-md-6 col-12 mt-2">
                        ...
                        <input type="text" class="form-control form-control-sm @error('meta_title') is-invalid @enderror" name="meta_title" id="meta_title">
                        @error('meta_title')
                            <div class="alert alert-danger">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-12 mt-2">
                        ...
                        <input type="text" class="form-control form-control-sm @error('meta_tag') is-invalid @enderror" name="meta_tag" id="meta_tag">
                        @error('meta_tag')
                            <div class="alert alert-danger">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-12 mt-4">
                        ...
                        <textarea type="text" class="form-control form-control-sm @error('meta_description') is-invalid @enderror" name="meta_description"  rows="6"></textarea>
