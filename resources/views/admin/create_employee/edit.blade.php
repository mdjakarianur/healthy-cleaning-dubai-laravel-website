            ...
            <form method="post" action="{{route('create_employee.update',$data['data']->id)}}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-2">
                        <label>@lang('create_employee.joining_date')</label><span class="text-danger">*</span>
                        <input type="date" class="form-control form-control-sm @error('joining_date') is-invalid @enderror" name="joining_date" id="joining_date"  value="{{ $data['data']->joining_date }}">
                        @error('joining_date')
                            <div class="alert alert-danger">
                                {{ $message }}
                            </div>
