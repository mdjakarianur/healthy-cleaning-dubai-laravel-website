...
<div class="content">
    ...
    <!-- Active Link -->
    @slot('active_link')
    @lang('create_employee.index_title')
    @endslot
    ...
    @if(Auth::user()->can('Create Employee create'))
    <!-- button one -->
    ...
    @if(Auth::user()->can('Create Employee trash'))
    <!-- button two -->
    ...
    {{route('create_employee.trash_list')}}
    @endslot
                ...
                <table class="table myTable  fs--1 mb-0">
                    <thead>
                        <tr>
                            ...
                            <th>@lang('create_employee.joining_date')</th>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    $(".myTable").DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('create_employee.index') }}",
        columns: [
            {data: 'sl', name: 'sl'},
            {data: 'name', name: 'name'},
