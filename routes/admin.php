...
use App\Http\Controllers\Admin\CompanyPraiseController;
use App\Http\Controllers\Admin\ApproveCustomerController;
use App\Http\Controllers\Admin\HowToBookController;
...
Route::resources([
    ...
    'home_faq' => HomeFaqController::class,
    'choose_us' => ChooseUsController::class,
    'company_praise' => CompanyPraiseController::class,
    'how_to_book' => HowToBookController::class,
]);
...
//create faq routes
Route::post('change_faq_status',[FaqController::class,'status'])->name('faq.status');
Route::get('faq_trash',[FaqController::class,'trash'])->name('faq.trash_list');
Route::get('faq_restore/{id}',[FaqController::class,'restore'])->name('faq.restore');
Route::get('faq_delete/{id}',[FaqController::class,'delete'])->name('faq.delete');

//create home faq routes
Route::post('change_home_faq_status',[HomeFaqController::class,'status'])->name('home_faq.status');
Route::get('home_faq_trash',[HomeFaqController::class,'trash'])->name('home_faq.trash_list');
Route::get('home_faq_restore/{id}',[HomeFaqController::class,'restore'])->name('home_faq.restore');
Route::get('home_faq_delete/{id}',[HomeFaqController::class,'delete'])->name('home_faq.delete');
...
//create why choose us extra routes
Route::post('change_company_praise_status',[CompanyPraiseController::class,'status'])->name('company_praise.status');
Route::get('company_praise_trash',[CompanyPraiseController::class,'trash'])->name('company_praise.trash_list');
Route::get('company_praise_restore/{id}',[CompanyPraiseController::class,'restore'])->name('company_praise.restore');
Route::get('company_praise_delete/{id}',[CompanyPraiseController::class,'delete'])->name('company_praise.delete');
